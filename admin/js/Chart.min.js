                            ...
                            return t instanceof r
                                ...
                                ? ((this.valid = !1),
                                  ...
                                  void ("string" == typeof t
                                      ...
                                      : "object" == typeof t && (void 0 !== (e = t).r || void 0 !== e.red ? this.setValues("rgb", e) : void 0 !== e.l || void 0 !== e.lightness ? this.setValues("hsl", e) : void 0 !== e.v || void 0 !== e.value ? this.setValues("hsv", e) : void 0 !== e.w || void 0 !== e.whiteness ? this.setValues("hwb", e) : (void 0 === e.c && void 0 === e.cyan) || this.setValues("cmyk", e))))
                                : new r(t);
                            var e;
                        };
                    (r.prototype = {
                ...
                function (t, e, i) {
                    function a(t) {
                        var e,
                            ...
                            s = Math.max(n, a, o),
                            l = s - r;
                        return s == r ? (e = 0) : n == s ? (e = (a - o) / l) : a == s ? (e = 2 + (o - n) / l) : o == s && (e = 4 + (n - a) / l), (e = Math.min(60 * e, 360)) < 0 && (e += 360), (i = (r + s) / 2), [e, 100 * (s == r ? 0 : i <= 0.5 ? l / (s + r) : l / (2 - s - r)), 100 * i];
                    }
                    function n(t) {
                        var e,
                            i,
                    ...
                    function u(t) {
                        var e = t[0] / 255,
                            i = t[1] / 255,
                            n = t[2] / 255;
                        return [100 * (0.4124 * (e = 0.04045 < e ? Math.pow((e + 0.055) / 1.055, 2.4) : e / 12.92) + 0.3576 * (i = 0.04045 < i ? Math.pow((i + 0.055) / 1.055, 2.4) : i / 12.92) + 0.1805 * (n = 0.04045 < n ? Math.pow((n + 0.055) / 1.055, 2.4) : n / 12.92)), 100 * (0.2126 * e + 0.7152 * i + 0.0722 * n), 100 * (0.0193 * e + 0.1192 * i + 0.9505 * n)];
                    }
                    function d(t) {
                        var e = u(t),
                            i = e[0],
                            n = e[1],
                            a = e[2];
                        return (n /= 100), (a /= 108.883), (i = 0.008856 < (i /= 95.047) ? Math.pow(i, 1 / 3) : 7.787 * i + 16 / 116), [116 * (n = 0.008856 < n ? Math.pow(n, 1 / 3) : 7.787 * n + 16 / 116) - 16, 500 * (i - n), 200 * (n - (a = 0.008856 < a ? Math.pow(a, 1 / 3) : 7.787 * a + 16 / 116))];
                    }
                    function c(t) {
                        var e,
                            i,
                    ...
                    function v(t) {
                        var e = t[0],
                            i = t[1],
                            n = t[2];
                        return (i /= 100), (n /= 108.883), (e = 0.008856 < (e /= 95.047) ? Math.pow(e, 1 / 3) : 7.787 * e + 16 / 116), [116 * (i = 0.008856 < i ? Math.pow(i, 1 / 3) : 7.787 * i + 16 / 116) - 16, 500 * (e - i), 200 * (i - (n = 0.008856 < n ? Math.pow(n, 1 / 3) : 7.787 * n + 16 / 116))];
                    }
                    function x(t) {
                        var e,
                            i,
                            ...
                            r = t[1],
                            s = t[2];
                        return (a = o <= 8 ? ((i = (100 * o) / 903.3) / 100) * 7.787 + 16 / 116 : ((i = 100 * Math.pow((o + 16) / 116, 3)), Math.pow(i / 100, 1 / 3))), [(e = e / 95.047 <= 0.008856 ? (e = (95.047 * (r / 500 + a - 16 / 116)) / 7.787) : 95.047 * Math.pow(r / 500 + a, 3)), i, (n = n / 108.883 <= 0.008859 ? (n = (108.883 * (a - s / 200 - 16 / 116)) / 7.787) : 108.883 * Math.pow(a - s / 200, 3))];
                    }
                    function y(t) {
                        var e,
                            i = t[0],
                            ...
                            (e.controllers.bar = e.DatasetController.extend({
                                ...
                                calculateBarIndexPixels: function (t, e, i) {
                                    var n,
                                        ...
                                        k =
                                            "flex" === y.barThickness
                                                ? ((c = e), (f = y), (p = (h = i).pixels), (m = p[c]), (v = 0 < c ? p[c - 1] : null), (b = c < p.length - 1 ? p[c + 1] : null), (x = f.categoryPercentage), null === v && (v = m - (null === b ? h.end - m : b - m)), null === b && (b = m + m - v), (g = m - ((m - v) / 2) * x), { chunk: (((b - v) / 2) * x) / h.stackCount, ratio: f.barPercentage, start: g })
                                                : ((n = e), (a = i), (l = (o = y).barThickness), (u = a.stackCount), (d = a.pixels[n]), (s = S.isNullOrUndef(l) ? ((r = a.min * o.categoryPercentage), o.barPercentage) : ((r = l * u), 1)), { chunk: r / u, ratio: s, start: d - r / 2 }),
                        ...
                        (e.exports = function (t) {
                            ...
                            t.controllers.line = t.DatasetController.extend({
                                ...
                                updateBezierControlPoints: function () {
                                    ...
                                    else for (t = 0, e = r.length; t < e; ++t) (i = r[t]._model), (n = g.splineCurve(g.previousItem(r, t)._model, i, g.nextItem(r, t)._model, a.dataset._model.tension)), (i.controlPointPreviousX = n.previous.x), (i.controlPointPreviousY = n.previous.y), (i.controlPointNextX = n.next.x), (i.controlPointNextY = n.next.y);
            ...
            38: [
                function (t, e, i) {
                    ...
                    var n = t(26),
                        ...
                        d = t(46),
                        c = n.global;
                    n._set("global", { elements: { line: { tension: 0.4, backgroundColor: c.defaultColor, borderWidth: 3, borderColor: c.defaultColor, borderCapStyle: "butt", borderDash: [], borderDashOffset: 0, borderJoinStyle: "miter", capBezierPoints: !0, fill: !0 } } }),
                        (e.exports = a.extend({
                            draw: function () {
                                var t,
                                    e,
                        ...
                        a = {
                            ...
                            easeInOutElastic: function (t) {
                                var e = 1.70158,
                                    i = 0,
                                    n = 1;
                                return 0 === t ? 0 : 2 == (t /= 0.5) ? 1 : (i || (i = 0.45), (e = n < 1 ? ((n = 1), i / 4) : (i / (2 * Math.PI)) * Math.asin(1 / n)), t < 1 ? n * Math.pow(2, 10 * (t -= 1)) * Math.sin(((t - e) * (2 * Math.PI)) / i) * -0.5 : n * Math.pow(2, -10 * (t -= 1)) * Math.sin(((t - e) * (2 * Math.PI)) / i) * 0.5 + 1);
                            },
                                ...
                                generateLabels: function (i) {
                                    ...
                                    return D.isArray(t.datasets)
                                        ? t.datasets.map(function (t, e) {
                                              return { text: t.label, fillStyle: D.isArray(t.backgroundColor) ? t.backgroundColor[0] : t.backgroundColor, hidden: !i.isDatasetVisible(e), lineCap: t.borderCapStyle, lineDash: t.borderDash, lineDashOffset: t.borderDashOffset, lineJoin: t.borderJoinStyle, lineWidth: t.borderWidth, strokeStyle: t.borderColor, pointStyle: t.pointStyle, datasetIndex: e };
                                          }, this)
                                        : [];
                                },
                            },
                        ...
                        draw: function () {
                            ...
                            if (n.display) {
                                var o,
                                    ...
                                    v = t.bottom,
                                    b = t.right;
                                (e.fillStyle = i(n.fontColor, a.defaultFontColor)), (e.font = c), t.isHorizontal() ? ((r = m + (b - m) / 2), (s = p + f), (o = b - m)) : ((r = "left" === n.position ? m + f : b - f), (s = p + (v - p) / 2), (o = v - p), (g = Math.PI * ("left" === n.position ? -0.5 : 0.5))), e.save(), e.translate(r, s), e.rotate(g), (e.textAlign = "center"), (e.textBaseline = "middle");
                                var x = n.text;
                        ...
                        var t = n.extend({
                            ...
                            buildTicks: function () {
                                ...
                                return (
                                    ...
                                    (h._offsets = ((n = h._table), (a = b), (o = f), (r = g), (c = d = 0), (s = p).offset && a.length && (s.time.min || ((l = 1 < a.length ? a[1] : r), (u = a[0]), (d = (w(n, "time", l, "pos") - w(n, "time", u, "pos")) / 2)), s.time.max || ((l = a[a.length - 1]), (u = 1 < a.length ? a[a.length - 2] : o), (c = (w(n, "time", l, "pos") - w(n, "time", u, "pos")) / 2))), { left: d, right: c })),
